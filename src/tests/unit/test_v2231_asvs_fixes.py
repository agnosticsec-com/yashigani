...
class TestEscapeCsvCell:
    ...
    # -------------------------------------------------------------------------
    # LF-CSV-BYPASS regression tests (Compliance 2026-04-27)
    # These are the six bypasses Compliance empirically reproduced against the original
...
class TestDashboardJsEscapeHtmlPresent:
    ...
    a browser; that belongs to the QA Playwright suite.
    """

...
A4 (2026-05-02): Added router-level require_admin_session dependency.
All 8 endpoints were previously unauthenticated (OWASP API3:2023 / ASVS V4.1.1).
No middleware covered /admin/budget/* — the uniform_admin_404_as_401 middleware
only masks 404→401; it does not enforce auth on reachable routes. The router-level
Depends() protects all current and future endpoints in this file.
